## Purpose
This project is a simple calculator that can compute basic mathmatical expressions.
...
Configure your launch.json file to include the configuration: <br> "vm-Args": "--module-path ./lib --add-modules=javafx.controls".